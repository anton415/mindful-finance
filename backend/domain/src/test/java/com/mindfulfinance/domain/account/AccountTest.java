...
/**
 * Unit tests for the Account class. This class is currently a placeholder and should be implemented
 * with actual test cases to verify the behavior of the Account class.
 */
public class AccountTest {
  ...
  void shouldRejectDeletingAccountWithTransactions() {
    ...
    DomainException exception =
        assertThrows(DomainException.class, () -> account.ensureCanBeDeleted(true));
