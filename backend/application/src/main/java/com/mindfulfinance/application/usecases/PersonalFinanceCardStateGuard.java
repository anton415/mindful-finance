...
final class PersonalFinanceCardStateGuard {
  static final String ARCHIVED_CARD_READ_ONLY_MESSAGE =
      "Archived personal finance cards are read-only";

  private PersonalFinanceCardStateGuard() {}

  static PersonalFinanceCard requireMutableCard(
      PersonalFinanceCardRepository repository, PersonalFinanceCardId cardId) {
