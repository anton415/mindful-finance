...
public class ComputeMonthlyBurnByCurrencyTest {
  ...
  ComputeMonthlyBurnByCurrency computeBurn =
      new ComputeMonthlyBurnByCurrency(accounts, transactions);
  ...
  void shouldThrowOnCurrencyMismatch() {
    ...
    IllegalStateException exception =
        assertThrows(
            IllegalStateException.class, () -> computeBurn.compute(LocalDate.of(2026, 3, 31)));
