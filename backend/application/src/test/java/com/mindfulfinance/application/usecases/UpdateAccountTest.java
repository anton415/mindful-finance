...
public class UpdateAccountTest {
  ...
  void shouldUpdateAccountNameAndTypeWhilePreservingImmutableFields() {
    ...
    Optional<Account> updated =
        useCase.update(new UpdateAccount.Command(accountId, "  Main Brokerage  ", BROKERAGE));
  ...
  void shouldReturnEmptyWhenAccountDoesNotExist() {
    Optional<Account> updated =
        useCase.update(
            new UpdateAccount.Command(AccountId.random(), "Main Brokerage", AccountType.BROKERAGE));
